...
const SOLID_TYPES = Object.freeze({ LIQUID: 'LIQUID', GAS: 'GAS', SOLID: 'SOLID', LIVING: 'LIVING', STATIC: 'STATIC' })
...
const PARTICLE_TYPES = Object.freeze({
	...
	OIL: 'OIL', DIAMOND: 'DIAMOND', GRASS: 'GRASS', ACID: 'ACID', ROCK: 'ROCK', LAVA: 'LAVA', CLOUD: 'CLOUD',
	SMOKE: 'SMOKE', MAGMA: 'MAGMA', COAL: 'COAL', BUBBLE: 'BUBBLE', STEAM: 'STEAM',})
const particleKeys = Object.keys(PARTICLE_TYPES);
const PARTICLE_PROPERTIES = {
	...
	[PARTICLE_TYPES.WOOD]: { color: 'rgba(74, 54, 10, 1)', lifeTime: Infinity, flammability: 950, burner: 0, douse: 0, solType: SOLID_TYPES.SOLID, updType: UPDATE_TYPES.STATIC, density: 20, spread: 10},
	...
	[PARTICLE_TYPES.TORCH]: { color: 'rgba(255, 0, 0, 1)', lifeTime: Infinity, flammability: 0, burner: 1000, douse: 0, solType: SOLID_TYPES.STATIC, updType: UPDATE_TYPES.DYNAMIC, density: 1, spread: 10 },
