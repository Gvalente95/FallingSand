function delCellsAtPos(x = MOUSE.x - BRUSHSIZE / 2 + PIXELSIZE, y = MOUSE.y - BRUSHSIZE / 2 + PIXELSIZE, radius = BRUSHSIZE, type = null, isDisc = 'DISC') {
...
function delEntsAtPos(x = MOUSE.gridX, y = MOUSE.gridY, radius = BRUSHSIZE) {
